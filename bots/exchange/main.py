...
# ==== CONFIGURATION ====
REPLAY_SPEED = 1000.0  # Speed multiplier for playback
START_TIME = datetime(2025, 6, 9, 17, 0, 0, tzinfo=timezone.utc)
WINDOW_MINUTES = 700      # Duration of replay window
REPLAY = True
# ==== PATH SETUP ====
...
# ==== INITIALIZATION ====
RESET_KLINE_WINDOWS_ON_START = True   # Clear the redis memory so on restart we are not using stale kline data
